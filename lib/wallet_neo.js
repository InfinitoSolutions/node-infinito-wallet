 ...
 */
  ...
  async  createTransferTx(contractAddress, to, amount, decimal = Constant.NEO.GASDecimal) {
    ...
    const fromAddrScriptHash = wallet.getScriptHashFromAddress(this.Account.address);
    const toAddrScriptHash = Neon.u.reverseHex(wallet.getScriptHashFromAddress(to))
