 ...
 */
  ...
  /**
   * @param  {Object} api           (required)  API is instanse of InfinitApi
   */
  setApi(api) {
    this[_api] = api;
   ...
   * @param  {Number}  txParams.fee            (optional)  Fee that you want to pay for this transaction, if dont set you can use feeType. fee is priority than feeType
   ...
   * @param  {Number}  params.fee                    (optional)  Fee that you want to pay for this transaction, if dont set you can use feeType. fee is priority than feeType
