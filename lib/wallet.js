...
class Wallet {
  ...
  constructor(options) {
    ...
    this.network = options.isTestNet ? Bitcoinjs.networks.testnet : Bitcoinjs.networks.bitcoin;
  }
...
*/
  ...
  createRawTx(receiver, amount, listUnspent, feePerB) {
    ...
    let keyPair = Bitcoinjs.ECPair.fromWIF(this.Account.wif, this.network);
