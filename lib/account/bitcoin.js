...
class BitcoinAccount {
  ...
  constructor(options) {
    ...
    let result = null;
    if (this.wif) {
      result = generateAccount(this.wif, true, this.coinType, options.isTestNet);
      this.privateKey = result.privateKey;
    } else
      result = generateAccount(this.privateKey, false, this.coinType, options.isTestNet);
...
function generateAccount(privateKey, isWif, coinType, isTestNet = false) {
  let keyPair = null;
